...
public class BitInputStream extends InputStream {
	 ...
	 * <p>
	 * Consecutive calls to this method will consume one bit at a time from the
	 * underlying stream. If any of the other read methods are called all
	 * remaining bits up to the next byte boundary will be discarded.
	 * 
